...
In json format:
```
curl -X POST -d '{"n1c0_dissertation_argument":{"title":"myTitleArgument","body":"myBodyArgument"}}' http://localhost:8000/api/v1/arguments/10.json --header "Content-Type:application/json" -v
```
