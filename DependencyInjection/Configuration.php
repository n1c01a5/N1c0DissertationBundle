                ...
                ->arrayNode('form')->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->arrayNode('introduction')->addDefaultsIfNotSet()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('transition')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('type')->defaultValue('n1c0_dissertation_transition')->end()
                                ->scalarNode('name')->defaultValue('n1c0_dissertation_transition')->end()
                            ->end()
                        ->end()
                    ...
                    ->children()
                        ->arrayNode('model')->isRequired()
                            ->children()
                                ...
                                ->scalarNode('transition')->isRequired()->end()
                    ...
                    ->children()
                        ->arrayNode('manager')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('transition')->cannotBeEmpty()->defaultValue('n1c0_dissertation.manager.transition.default')->end()
                        ...
                        ->arrayNode('acl')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('transition')->cannotBeEmpty()->defaultValue('n1c0_dissertation.acl.transition.security')->end()
                        ...
                        ->arrayNode('form_factory')->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('transition')->cannotBeEmpty()->defaultValue('n1c0_dissertation.form_factory.transition.default')->end()
